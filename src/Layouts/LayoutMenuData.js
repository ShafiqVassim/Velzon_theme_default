...
const Navdata = () => {
    ...
    const [isNuvolance, setIsNuvolance] = useState(false);
    ...
    useEffect(() => {
        ...
        if (iscurrentState !== 'Nuvolance') {
            setIsNuvolance(false);
        }
    ...
    const menuItems = [
        ...
        },
        {
            ...
            link: "/#",
            stateVariables: isNuvolance,
            click: function (e) {
                e.preventDefault();
                setIsNuvolance(!isNuvolance);
                setIscurrentState('Nuvolance');
                updateIconSidebar(e);
            },
            subItems: [
                {
